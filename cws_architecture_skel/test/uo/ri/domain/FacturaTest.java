...
public class FacturaTest {
	...
	/**
	 * Calculo del importe de factura con una avería de 260€ + IVA 21% La averia se
	...
	/**
	 * Si la factura es anterior al 1/7/2012 el IVA es el 18%, el importe es 250€ +
	 * IVA 18%
	 */
	@Test
	...
	/**
	 * Una avería al añadirla a una factura cambia su estado a FACTURADA al añadirla
	 * por constructor
	 */
	@Test
	...
	/**
	 * Una averia al añadirla a una factura cambia su estado a FACTURADA al añadirla
	 * por asociación
	 */
	@Test
	...
	/**
	 * Genera nueva factura esperando 100 milisegundos para evitar que coincida el
	 * campo fecha si se generan dos facturas muy seguidas (en el mismo milisegundo)
	 * 
