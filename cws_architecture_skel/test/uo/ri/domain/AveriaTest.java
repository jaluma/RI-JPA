...
public class AveriaTest {
	...
	/**
	 * Cálculo correcto de importe de avería al quitar intervenciones El (re)cálculo
	 * se hace al pasar la avería a TERMINADA
	 */
	@Test
	...
	/**
	 * No se puede añadir a una factura una averia no terminada y lo indica lanzando
	...
	/**
	 * Una averia no puede ser marcada como facturada si no tiene factura asignada
	 * 
	 * @throws IllegalStateException
	 */
	@Test(expected = IllegalStateException.class)
