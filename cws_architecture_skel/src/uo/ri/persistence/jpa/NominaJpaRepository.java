...
public class NominaJpaRepository extends BaseRepository<Payroll>
	 ...
	 * 
	 * @see
	 * uo.ri.business.repository.NominaRepository#findPayrollsByMechanicId(java.
	 * lang.Long)
	 */
	@Override
	public List<Payroll> findPayrollsByMechanicId(Long mechanicId) {
		return Jpa.getManager()
				.createNamedQuery("Nomina.findPayrollsByMechanicId",
						Payroll.class)
	 ...
	 * 
	 * @see
	 * uo.ri.business.repository.NominaRepository#findByContractAndDate(java.
	...
	public Payroll findByContractAndDate(Long contratoId, Date date) {
		return Jpa.getManager()
				...
				.setParameter(1, contratoId).setParameter(2, date)
	 ...
	 * 
	 * @see
	 * uo.ri.business.repository.NominaRepository#findLastPayrollByMechanicId(
	 * java.lang.Long)
	 */
	@Override
	public Payroll findLastPayrollByMechanicId(Long idMecanico) {
		return Jpa.getManager()
				.createNamedQuery("Nomina.findLastPayrollByMechanicId",
						Payroll.class)
				.setParameter(1, idMecanico).getResultList().stream()
